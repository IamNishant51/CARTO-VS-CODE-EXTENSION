  ...
  resolveWebviewView(webview: vscode.WebviewView) {
    ...
    webview.webview.onDidReceiveMessage(async (msg) => {
      ...
      if (msg.type === 'save_settings') {
        ...
        if (msg.data.gemini !== null) await config.update('geminiApiKey', msg.data.gemini, vscode.ConfigurationTarget.Global);
        if (msg.data.openai !== null) await config.update('openaiApiKey', msg.data.openai, vscode.ConfigurationTarget.Global);
        if (msg.data.groq !== null) await config.update('groqApiKey', msg.data.groq, vscode.ConfigurationTarget.Global);
